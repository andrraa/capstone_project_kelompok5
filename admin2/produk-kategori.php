...
<head>
  ...
  <title>Admin - Tabel Produk Kategori</title>
  ...
  <!-- Main content -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Data Produk Kategori</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    ?>
                    <tr>
                      ...
                      <td><?php echo $row['deskripsi_produk_kategori']; ?></td>
      ...
      <div class="modal fade" id="modalTambah">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="judulModal">Tambah Produk Kategori</h4>
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="produk-kategori-c.php">
                  <input type="hidden" name="simpanProdukKategori">
                  <div class="card-body">
                    <div class="form-group row">
        ...
        <div class="modal fade" id="modalEdit">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="judulModal">Edit Produk Kategori</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="produk-kategori-c.php">
                  <input type="hidden" name="editProdukKategori" >
        ...
        <div class="modal fade" id="modalHapus">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="produk-kategori-c.php">
                  <input type="hidden" name="hapusProdukKategori" >
