...
<div class="wrapper">
  ...
  <!-- Main content -->
      <section class="content">
                  ...
                  <div class="form-group row" style=" float: right;margin-bottom: 10px;width:50%; min-width: 300px;">
                    ...
                    <div class="col-sm-9 col-md-10">
                      <form class="form-horizontal" method="get" action="">
                        ...
                        <div class="col-sm-0" style="margin-right:1%"></div>
                        <a class="btn btn-secondary col-sm-2" href="pelanggan.php">Reset</a>
                        </div>
                      </form>
                    </div>
                  </div>
        ...
        $data = mysqli_query($con,"select * from pelanggan where nama_pelanggan like '%$cari%' or email_pelanggan like '%$cari%' or alamat_pelanggan like '%$cari%' or jenis_kelamin_pelanggan like '%$cari%'");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);
        $no = $halaman_awal+1;


    $query = "select * from pelanggan where nama_pelanggan like '%$cari%' or email_pelanggan like '%$cari%' or alamat_pelanggan like '%$cari%' or jenis_kelamin_pelanggan like '%$cari%' order by id_pelanggan desc limit $halaman_awal, $batas";
    $rows = mysqli_query($con, $query);
    while ($row = mysqli_fetch_array($rows)) {
    ?>
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td style="text-align: center;"><img src="image/foto_pelanggan/<?php echo $row['foto_pelanggan']; ?>" style="height:80px;max-width:600px"></td>
                      <td><?php echo $row['nama_pelanggan']; ?></td>
                      <td><?php echo $row['email_pelanggan']; ?></td>
                      <td><?php echo $row['alamat_pelanggan']; ?></td>
                      <td><?php echo $row['jenis_kelamin_pelanggan']; ?></td>
                      <td><button type="button" class="btn btn-block btn-primary btnEdit" data-toggle="modal" data-target="#modalEditVisiMisi"  data-id=<?php echo $row["id_pelanggan"] ?>>Edit</button></td>
                      <td><button type="button" class="btn btn-block btn-danger btnHapus" data-toggle="modal" data-target="#modalHapusVisiMisi" data-id=<?php echo $row["id_pelanggan"] ?>>Hapus</button></td>
                    </tr>
                  <?php
                  }
                  ?>
      ...
      <div class="modal fade" id="modalTambahVisiMisi">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="judulModal">Tambah Pelanggan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="pelanggan-c.php" enctype="multipart/form-data">
                  <input type="hidden" name="simpanPelanggan">
                  <div class="card-body">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Foto Pelanggan</label>
                      <div class="col-sm-10">
                        <div class="custom-file"> 
                          <input type="file" name = "foto_pelanggan" class="custom-file-input">
                          <label class="custom-file-label" for="foto_pelanggan">Choose file</label>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal fade" id="modalEditVisiMisi">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="judulModal">Edit Pelanggan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="pelanggan-c.php" enctype="multipart/form-data">
                  <input type="hidden" name="editPelanggan" >
                  <input type="hidden" name="id_pelanggan" id="eid_pelanggan">
                  <div class="card-body">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Foto Pelanggan</label>
                      <div class="col-sm-10">
                        <div class="custom-file"> 
                          <input type="file" id="efoto_pelanggan" name="foto_pelanggan" class="custom-file-input">
                          <label class="custom-file-label" for="foto_pelanggan">Choose file</label>
                        </div>
                      </div>
                    </div>
                    <div class="form-group row"> 
                      ...
                      <div class="col-sm-10">
                        <div class="custom-file"id="esifoto_pelanggan">
                          <img src="image/foto_pelanggan/sablon.png" style="margin-bottom: 120px;height:150px;max-width:800px">
                        </div>
                      </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal fade" id="modalHapusVisiMisi">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" method="post" action="pelanggan-c.php">
                  <input type="hidden" name="hapusPelanggan" >
                  <input type="hidden" name="id_pelanggan" id="hid_pelanggan">
                  <div class="card-body">
                    <div class="form-group row"> 
                      <label class="col-sm-2 col-form-label">Foto Pelanggan</label> 
                      <div class="col-sm-10">
                        <div class="custom-file"id="hsifoto_pelanggan">
                          <img src="image/foto_pelanggan/sablon.png" style="margin-bottom: 120px;height:150px;max-width:800px">
                        </div>
                      </div>
                    </div>
    ...
    $.ajax({
        ...
        type: "GET",
            success: function (data) {
              ...
              $('#esifoto_pelanggan').html("<img src='image/foto_pelanggan/"+myObj.foto_pelanggan+"' style='margin-bottom: 120px;height:150px;max-width:800px'>");
              $('#enama').val(myObj.nama_pelanggan);
    ...
    $.ajax({
        ...
        type: "GET",
            success: function (data) {
              ...
              $('#hsifoto_pelanggan').html("<img src='image/foto_pelanggan/"+myObj.foto_pelanggan+"' style='margin-bottom: 120px;height:150px;max-width:800px'>");
              $('#hnama').val(myObj.nama_pelanggan);
              $('#hemail').val(myObj.email_pelanggan);
              $('#hpassword').val(myObj.password_pelanggan);
              $('#halamat').val(myObj.alamat_pelanggan);
              $('#hjenis_kelamin').val(myObj.jenis_kelamin_pelanggan);
